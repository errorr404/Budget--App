   ...
   var formatNumber = function(num,type){
     ...
     return {
        ...
        description: document.querySelector(DOMstrings.inputDescription).value,
         ...
         displayPercentage: function(precentages){
        ...
        displayMonth: function(){
            ...
            var now = new Date();
           // var christmas = new date(26,11,25);
            var year = now.getFullYear(); // return the current year
...
var controller = (function(budgetctrl, UICtrl){
    ...
    document.addEventListener('keypress',function(event){
        ...
        document.querySelector(DOM.inputType).addEventListener('change',UICtrl.chagedType);
    ...
    var updatePercentages = function(){
        ...
        budgetController.calculatePercetages();
        
        //2. Read percentage from the budget cintroller
        
      var percen = budgetController.getPercentages();
